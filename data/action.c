Action()
{
	...
	web_add_cookie("GAPS=1:eJ_rCXo2JFF0V_C1o5Km8QVVhkdtRw:oxX9WJVkyXNHRnp2; DOMAIN=accounts.google.com");

	web_add_cookie("NID=154=cmGqxf_pZdXak78UhnBMoBM5a8-uCA40xag1VIchLyQRELpZ0bpzqsmkaZgwnnWgA_wApCAZ_TgOCNoZVVGLdB6SaSzuQL5plf5jOvUQUGJQ9viPAtBBysE2RgwyJ1ZYkW2wWR0PiT3oZj1SQ9jxIGZnu_-cZpQ-kRf-W9wJyfE; DOMAIN=accounts.google.com");

	web_add_cookie("1P_JAR=2019-01-17-05; DOMAIN=accounts.google.com");
	...
	web_url("json", 
		"URL=https://ipapi.co/61.12.76.46/json", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.testhouse.net/", 
		"Snapshot=t10.inf", 
		"Mode=HTML", 
		EXTRARES, 
		"Url=https://www.testhouse.net/ast/themes/testhouse/images/circle-arrow.png", "Referer=https://www.testhouse.net/ast/themes/testhouse/css/styles.css?ver=20160816", ENDITEM, 
		LAST);
